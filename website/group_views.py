...
@group_views.route('/group-chat/<string:group_chat>', methods=['GET', 'POST'])
@login_required
...
@group_views.route('/delete-message-group/<string:message_id>/<string:group_name>', methods=['GET', 'POST'])
def delete_message_group(message_id, group_name):
    ...
    return redirect('/group-chat/' + group_name)